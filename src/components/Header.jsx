  ...
  return (
    <div className='text-white'>
        ...
        <div className='flex items-center justify-between'>
            ...
            <span className='font-semibold text-xl'>envato<span className='font-normal text-lg'>market</span></span>
            </div>
            <button className='px-3 py-1 bg-[#82B440] text-white rounded'>Buy now</button>
        </div>
        </div>
        ...
        <div className='flex items-center justify-between text-black'>
            ...
            <div className='flex items-center bg-[#1d1729] text-white px-12 xl:px-16 py-2 lg:py-8 border-r-4 border-[#7243f2] '>
            ...
            <div className='hidden lg:flex items-center gap-8 mr-4 xl:mr-0'>
                ...
                <span className='text-xl font-semibold group-hover:text-[#7243f2]'>Home</span>
                ...
                <span className='group-hover:border border-[#7243f2] font-bold  w-14'></span>
                 ...
                 <div className='group flex flex-col'>
                 <div className='flex items-center gap-1'>
                <span className='text-xl group-hover:text-[#7243f2]'>Pages</span>
                <MdKeyboardArrowDown className='text-lg group-hover:text-[#7243f2]' />
                </div>
                ...
                <div className='group flex flex-col'>
                <div className='flex items-center gap-1'>
                <span className='text-xl group-hover:text-[#7243f2]'>Services</span>
                <MdKeyboardArrowDown className='text-lg group-hover:text-[#7243f2]' />
                </div>
                ...
                <div className='group flex flex-col'>
                <div className='flex items-center gap-1'>
                <span className='text-xl group-hover:text-[#7243f2]'>Projects</span>
                <MdKeyboardArrowDown className='text-lg group-hover:text-[#7243f2]' />
                </div>
                <span className='group-hover:border border-[#7243f2] font-bold  w-[70px]'></span>
                </div>
                ...
                <div className='group flex flex-col'>
                <div className='flex items-center gap-1'>
                <span className='text-xl group-hover:text-[#7243f2]'>News</span>
                <MdKeyboardArrowDown className='text-lg group-hover:text-[#7243f2]' />
                </div>
                <span className='group-hover:border border-[#7243f2] font-bold  w-12'></span>
                </div>
            ...
            <div className='flex items-center gap-4 pr-7'>
                <img src={message} alt="img" className='w-[40px] h-[40px] hidden xl:block' />
                <div className='hidden xl:flex flex-col pr-5'>
                    <span className='text-[#8D869D] font-normal'>Have any questions?</span>
                    <span className='text-lg font-medium'><span className='text-[#8D869D] text-base'>Free</span>+92(8800) - 9850</span>
                </div>
